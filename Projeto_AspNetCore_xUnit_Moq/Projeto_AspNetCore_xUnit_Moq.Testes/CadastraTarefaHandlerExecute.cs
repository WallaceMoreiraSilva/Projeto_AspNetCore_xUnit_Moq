...
namespace Projeto_AspNetCore_xUnit_Moq.Testes
{
    public class CadastraTarefaHandlerExecute
    {
        ...
        //LogLevel é o nivel de log que estou querendo. No nosso caso é o log de erro
        //EventId é o identificador do acontecimento.
        //state é a mensagem que a gente quer, o objeto que esta sendo logado. No nosso caso é "Houve um erro na inclusão de tarefas"
        //exception é a exceção lançada
        //Func<object, Exception, string> é uma funcao que pega o objeto que foi logado e a excecao e transforma isso em uma strig
        //criei um delegate que vai ser usado para capturar quando esse metodo for passado
        ...
        public void DadaTarefaComInfoValidasDeveLogar()
        {
            ...
            //aqui criamos uma instancia do tipo delegate
            //Aqui temos a funcao que vai ser chamada pelo Callback
            ...
            //faça uma configuracao para o metodo ILog pra qualquer argumento de entrada
            mockLogger.Setup(l =>
                l.Log(
                ...
                )).Callback(captura); //vou chamar uma funcao quando esse metodo ILog for chamado

            //vou criar um mock para simular o repositorio de tarefas
